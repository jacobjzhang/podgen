  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar */}
        <aside
          className={`${sidebarOpen ? 'w-[var(--sidebar-width)]' : 'w-0'} flex-shrink-0 bg-[var(--bg-secondary)] border-r border-[var(--border)] transition-all duration-300 overflow-hidden`}
        >
              ...
              {episode?.interests && (
                <div className="flex items-center gap-2">
                  {episode.interests.slice(0, 3).map((interest, i) => (
                    <span key={i} className="text-xs px-2.5 py-1 rounded-full bg-[var(--bg-tertiary)] text-[var(--text-secondary)]">
                      {interest}
                    </span>
                  ))}
          ...
          <div className="max-w-3xl mx-auto px-6 py-10">
            ...
            <div className="mb-10">
              <button
                ...
                className={`
                  w-full py-4 px-6 rounded-xl font-medium text-base transition-all
                ...
                <div className="grid gap-3">
                  {episode.newsItems.map((item, i) => (
                    <a
                      ...
                      className="block p-4 rounded-xl bg-[var(--bg-secondary)] border border-[var(--border)] hover:border-[var(--text-muted)] transition group"
                    >
